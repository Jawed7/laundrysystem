...
namespace laundry.Views.Customer
{
    public class CustomersController : Controller
    {
        private readonly laundryNewDbContext _context;

        public CustomersController(laundryNewDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> AddOrEdit([Bind("CustomerId,Name,Email,FPick_Up_Date,Type_Of_Ser,Address,Phone_number")] Customers customers)
        {
